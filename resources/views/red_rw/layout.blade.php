                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('red_rw/warga')}}">Data Warga</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('red_rw/datakk')}}">Data Kartu Keluarga</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('red_rw/ekonomi')}}">Data Level Ekonomi</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('red_rw/pekerjaan')}}">Data Pekerjaan Warga</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('red_rw/pendidikan')}}">Data Pendidikan</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('red_rw/agama')}}">Data Agama</a></li>
