                        ...
                        <ul>
                            ...
                            <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li class="{{ '/red_kt/warga'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_kt/warga')}}">Warga Pemuda</a>
                                        </li>
                                        <li class="{{ '/red_kt/laki' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_kt/laki')}}">Pemuda Laki-laki</a>
                                        </li>
                                        <li class="{{ '/red_kt/perempuan' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_kt/perempuan')}}">Pemuda Perempuan</a>
                                        </li>
                                        <li class="{{ '/red_kt/karangtaruna' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_kt/karangtaruna')}}">Anggota Karang Taruna</a>
                                        </li>
                                        <li class="{{ '/red_kt/keahlian' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_kt/keahlian')}}">Keahlian</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
