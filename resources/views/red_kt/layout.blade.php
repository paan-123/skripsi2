                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/red_kt/warga')}}">Warga Pemuda</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/red_kt/laki')}}">Pemuda Laki-laki</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/red_kt/perempuan')}}">Pemuda Perempuan</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/red_kt/karangtaruna')}}">Anggota Karang Taruna</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/red_kt/keahlian')}}">Keahlian</a></li>
