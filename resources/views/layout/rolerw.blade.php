                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/rw/detail')}}">Penggolongan Jenis Kelamin</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/rw/detail')}}">Penggolongan Usia</a></li>
