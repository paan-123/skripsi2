                        ...
                        <ul>
                            ...
                            <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li class="{{ '/rw/warga'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/warga')}}">Data Warga</a>
                                        </li>
                                        ...
                                        <li class="{{ '/rw/pekerjaan' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/pekerjaan')}}">Data Pekerjaan Warga</a>
                                        </li>
