                    ...
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <li class="sidebar-dropdown">
                                ...
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li class="{{ '/pkk/detail'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/pkk/detail')}}">Data RT 1</a>
                                        </li>
                                        <li class="{{ '/pkk/detail2' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/pkk/detail2')}}">Data RT 2</a>
                                        </li>
                                        <li class="{{ '/pkk/detail13' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/pkk/detail13')}}">Data RT 13</a>
                                        </li>
                                    </ul>
                                </div>
                            </li> --}}
