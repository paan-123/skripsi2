                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/pkk/warga')}}">Warga Perempuan</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/pkk/pkk')}}">Anggota PKK</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/pkk/kwt')}}">Anggota KWT</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/pkk/pekerjaan')}}">Pekerjaan</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/pkk/keahlian')}}">Keahlian</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/pkk/detail')}}">Data RT 1</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/pkk/detail2')}}">Data RT 2</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url ('/pkk/detail13')}}">Data RT 13</a></li>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{url('img/admin.jpg')}}" alt="User Avatar">
                        </a>
